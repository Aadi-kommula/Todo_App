  ...
  return (
    <div className='bg-gray-100 w-screen h-screen'>
      <div className='flex flex-col w-screen h-screen justify-center items-center'>
        ...
        <div className='flex text-sm w-80 justify-evenly mt-5 mb-2'>
          <div> <input onClick={() => handleCategory('work')} type="radio" name="category" id="work" /> Work</div>
          <div> <input onClick={() => handleCategory('personal')} type="radio" name="category" id="Personal" /> Personal</div>
          <div> <input onClick={() => handleCategory('urgent')} type="radio" name="category" id="Urgent" /> Urgent</div>
        </div>

        <div className='flex text-sm w-80 justify-evenly mt-4 mb-2'>
        ...
        {tab == 1 && todos?.map(todo => (
          <div className='flex justify-between bg-white p-3 w-80 mt-5 rounded-md'>
            <div>
              ...
              <p className='text-sm text-gray-700'>Category: {todo.category}</p>
            </div>
